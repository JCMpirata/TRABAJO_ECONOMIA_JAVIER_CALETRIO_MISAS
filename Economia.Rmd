...
interest_rates <- data.frame(
  ...
  InterestRate = c(3.354, 3.764, 4.217, 3.985, 3.222, 2.744, 2.609, 1.495, 1.571, 1.163, 0.495, 0.091, 0.316, 0.396, -0.254, -0.511, -0.374, 1.143)
)
...
tasa_de_inflacion <- data.frame(
  ...
  InterestRate = c(1.5, 1.6, 2.3, 2.6, 0.3, 1.1, 2.1, 2.0, 1.5, 0.9, 0.5, 0.5, 1.5, 1.7, 1.4, 0.1, 3.1, 6.9)
)
