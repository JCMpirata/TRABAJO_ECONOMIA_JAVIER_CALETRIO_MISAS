...
# Crear un gráfico de líneas para la tasa de inflación, inflación subyacente y deflactor del PIB
plot(data_inflacion_subyacente$Año, data_inflacion_subyacente$Tasa_Inflacion_Subyacente, 
     type = "l", col = "blue",
     xlab = "Año", ylab = "Tasa de Inflación Subyacente (%)",
     main = "Tasa de Inflación, Inflación Subyacente y Deflactor del PIB en Alemania (2005-2022)")

lines(data_deflactor_pib$Año, data_deflactor_pib$Deflactor_PIB, type = "l", col = "red")

lines(tasa_de_inflacion$Time, tasa_de_inflacion$TasadeInflacion, type = "l", col = "green")

# Agregar leyenda
legend("topright", legend = c("Tasa Inflación Subyacente", "Deflactor del PIB", "Tasa de Inflación"),
...
text(max(tasa_de_inflacion$Time), max(tasa_de_inflacion$TasadeInflacion),
     "Tasa de Inflación", col = "green", pos = 4)
...
combined_data <- merge(data_inflacion_subyacente, data_deflactor_pib, by = "Año")
...
ggplot(combined_data, aes(x = Año)) +
  ...
  geom_line(aes(y = Deflactor_PIB, color = "Deflactor del PIB")) +
  geom_line(aes(y = TasadeInflacion, color = "Tasa de Inflación")) +
  labs(
    title = "Tasa de Inflación, Inflación Subyacente y Deflactor del PIB en Alemania (2005-2022)",
    x = "Año",
    y = "Tasa (%)",
    color = "Indicador"
  ) +
  scale_color_manual(values = c("Tasa de Inflación Subyacente" = "blue", "Deflactor del PIB" = "red", "Tasa de Inflación" = "green")) +
  theme_minimal()
